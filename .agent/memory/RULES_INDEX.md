...
- **[R-265]** Supabase UPDATE de status — sempre checar retorno booleano (`revertToUnregistered`/`markTaken`). No-op silencioso (0 rows affected) não gera erro; `false` = race condition -> [`rules/mobile_and_platform/R-265.md`](./rules/mobile_and_platform/R-265.md)
- **[R-266]** `SafeAreaView` em telas com bottom tab nav — `edges={['top']}` apenas. React Navigation já gerencia o inset inferior; duplicar cria "caixa suspensa" -> [`rules/mobile_and_platform/R-266.md`](./rules/mobile_and_platform/R-266.md)
