...
- **[R-282]** server/ e api/ (Node ESM puro): imports relativos DEVEM manter extensão `.js`; nunca importar `.ts` de packages/ direto — extensionless só em código de bundler -> [`rules/infra_and_deploy/R-282.md`](./rules/infra_and_deploy/R-282.md)
