---
title: Missing Style Tokens Import in React Native Components
summary: >-
  ReferenceError: 'colors' is not defined. Falta de import de tokens ao padronizar UI nativa.
  (renumerado de AP-H26 no D5 — colisão de ID)
layer: warm
status: active
applies_to:
  paths:
...
# AP-197: Missing Style Tokens Import in React Native Components
