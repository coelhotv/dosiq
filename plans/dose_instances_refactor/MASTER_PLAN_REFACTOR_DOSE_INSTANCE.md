...
> **Status:** Em execução — **Fases 1–2 completas · Fase 3 (leitura ← dose_instances) em fechamento · Fase 4 iniciada** (PR-F4.1 ✅ merged #620; próximo: PR-F4.2 timeline UI web).
