...
> **Status:** ✅ **CONCLUÍDO — refactor completo (Fases 1–4 entregues, 2026-06-02).** Adesão/timeline/hoje viram **query** sobre `dose_instances` (não mais cálculo ±2h); fuso do usuário respeitado **ponta-a-ponta** (captura no signup → geração no fuso do dono → leitura do "hoje" → troca viagem×mudança + regen). Épico final **F4.3f** mergeado (PRs #628 captura/nudge · #629 geração+leitura · #630 troca de fuso). **Web 4.0.0 · Mobile 0.8.0 (release de loja).** Gaps G1–G8 fechados ou documentados. Doc técnica: [DOSE_INSTANCES.md](../../docs/architecture/DOSE_INSTANCES.md) · release: [mobile-v0.8.0.md](../../docs/releases/mobile-v0.8.0.md).
