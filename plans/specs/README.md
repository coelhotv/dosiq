...
| 031 | injection-site-rotation | **in-progress** | slice 031-A implementado (core+migração+web+mobile, web 4.10.0); 7/10 POs fechados (PO-3 alerta + PO-4/8 slice B pendentes); ADR-072 accepted; CON-026 +param; aguarda smoke PO + PR. 031-B (edit pós-log+hint+quick-pick) pendente |
