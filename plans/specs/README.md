...
| 063 | zero-lint-regressions | **in-progress** | Épico piloto de qualidade: zerar 140 warnings ESLint e gates. Thresholds ajustados p/ telas/modais/formatadores (-19 FPs). F1 entregue (commit 5cd70df) |
