...
| 050 | notification-integrity | **in-progress** | PRs #799 (`208327b`, US4 — SC-005 verificado em prod 2026-08-20), #800 (`116ef578`, `subject_id` na outbox — ADR-078, CON-035) e #801 (`65900d0f`, fan-out do `stock_alert`, inerte até o cutover). PR #802 aberto (`stock_expiry_alert`, fan-out por LOTE + `id` no select de `stock`). Falta o cutover (`OUTBOX_KINDS`, os dois kinds juntos) e o PR 3. Follow-up da 043; raiz da US4 na 064 |
