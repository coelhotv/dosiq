...
| 050 | notification-integrity | **in-progress** | PRs #799 (`208327b`, US4 — SC-005 verificado em prod 2026-08-20), #800 (`116ef578`, `subject_id` na outbox — ADR-078, CON-035) e #801 (`65900d0f`, fan-out do `stock_alert`, inerte até o cutover). #802 (`f16bdb0d`, `stock_expiry_alert` por LOTE + `id` no select de `stock`, inerte). Todo o código dos 4 PRs está em prod; **falta o cutover** (`OUTBOX_KINDS` += os dois kinds de estoque, juntos) + SC-003. PR 3 (claim atômico do lembrete, AP-332) em review no #803. Follow-up da 043; raiz da US4 na 064 |
