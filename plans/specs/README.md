...
| 033 | mobile-history-timeline-refactor | **in-progress** | Tier 1 — coding 2026-06-16. `historyTimelineService.js` (service-first, CON-023+CON-025) + `mapToMobileShape` (anti-corruption) + `BiomarkerHistoryCard` + refactor `useHistoryData.js` + `HistoryScreen.jsx` (MeasureLogSheet inline). 16 testes unitários (100% pass). mobile 0.19.0. Aguarda smoke+PR+merge. |
