...
| 050 | notification-integrity | **in-progress** | PRs #799 (`208327b`, US4 — SC-005 verificado em prod 2026-08-20), #800 (`116ef578`, `subject_id` na outbox — ADR-078, CON-035) e #801 (`65900d0f`, fan-out do `stock_alert`, inerte até o cutover). Próximo: PR 2 (expiry + cutover). Follow-up da 043; raiz da US4 na 064 |
