  ...
  return (
    <section className="feedback-admin__filters">
      ...
      <div className="feedback-admin__pagination-info">
        Exibindo <strong>{length}</strong> de <strong>{total}</strong> feedbacks
      </div>
    </section>
  )
}

function FeedbackList({ feedbacks, renderStars, handleResolveToggle, actionLoading }) {
  return (
...
export default function FeedbackAdmin({ onBack }) {
  ...
  return (
    <div className="feedback-admin">
      ...
      {/* Filtros */}
      <FeedbackFilters
        isResolvedFilter={isResolvedFilter}
        setIsResolvedFilter={setIsResolvedFilter}
