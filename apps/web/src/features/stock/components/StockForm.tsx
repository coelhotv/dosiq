...
import { useStockFormState } from '@features/stock/components/_useStockFormState'
import StockFormMedicineDetails from '@features/stock/components/sections/StockFormMedicineDetails'
import StockFormPurchaseDetails from '@features/stock/components/sections/StockFormPurchaseDetails'
import './StockForm.css'

export default function StockForm({ medicines, initialValues, onSave, onCancel }: any) {
  const {
    formData,
    errors,
    isSubmitting,
