...
export default function ProfileScreen() {
  ...
  const goToEdit = () => (navigation.navigate as any)(ROUTES.PROFILE_EDIT)
  const goToSettings = () => (navigation.navigate as any)(ROUTES.SETTINGS)
    ...
    <ScreenContainer>
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            style={styles.card}
            onPress={() => (navigation.navigate as any)(ROUTES.NOTIFICATION_INBOX, { userId: user?.id })}
            activeOpacity={0.7}
          >
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.card, { paddingVertical: 0 }]}>
            ...
            <TouchableOpacity
              style={styles.otherRow}
              onPress={() => (navigation.navigate as any)(ROUTES.FEEDBACK)}
              activeOpacity={0.7}
            >
              <View style={styles.otherLabelContainer}>
